...
class Horsebrands_Customer_AddressController extends Mage_Customer_AddressController
{
    /**
    ...
    public function formAction()
    {
        ...
        $block = $this->getLayout()->createBlock('customer/address_edit');
        $block->setTemplate('customer/address/edit.phtml');
        $html = $block->toHtml();
